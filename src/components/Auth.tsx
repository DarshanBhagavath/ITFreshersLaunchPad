...
export function Auth({ onAuthSuccess }: AuthProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl w-full max-w-md shadow-xl p-8 border border-gray-100 text-center">
        <div className="flex justify-center mb-6 text-indigo-600">
          <GraduationCap className="w-16 h-16" />
        </div>
        <h2 className="text-3xl font-bold text-gray-900 mb-2">IT Fresher Launchpad</h2>
        <p className="text-gray-600 mb-8">Sign in to search for jobs, view roadmaps, and generate your tailored AI resume.</p>
        
        <button 
          onClick={handleGoogleLogin}
          disabled={isLoading}
          className="w-full bg-white text-gray-700 font-medium py-3 px-4 border border-gray-300 rounded-lg hover:bg-gray-50 transition flex items-center justify-center gap-3"
        >
          {isLoading ? (
