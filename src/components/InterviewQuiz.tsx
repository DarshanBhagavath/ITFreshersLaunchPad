      ...
      <div className="max-w-4xl mx-auto py-12 px-4">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto text-lg">
            Test your knowledge with our comprehensive set of 50 most commonly asked interview questions for each major IT skill.
          </p>
        </div>
          ...
          {SKILLS.map((skill) => (
            ...
            >
              <div>
                ...
                <p className="text-gray-500 text-sm">50 Questions • Multiple Choice</p>
              </div>
